...
export default function Page() {
    return (
        <div className="relative w-full h-screen overflow-x-hidden bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#0f3460] text-white">
            ...
            <div className="relative h-screen min-[1150px]:grid min-[1150px]:grid-cols-[63fr_35fr]">
                <section className="!hidden min-[1150px]:!flex items-center justify-center px-6 lg:px-10 xl:px-16">
