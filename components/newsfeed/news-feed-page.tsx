            ...
            <section className="rounded-[1.5rem] border border-white/70 bg-white/80 p-4 shadow-[0_10px_40px_rgba(15,23,42,0.06)] backdrop-blur-sm dark:border-white/10 dark:bg-[#1c1c20]/85">
              <div className="flex items-center gap-3">
                <Link
                  ...
                  className="flex h-11 w-11 shrink-0 items-center justify-center overflow-hidden rounded-full border border-white/70 bg-zinc-200 transition hover:ring-2 hover:ring-[var(--primary-accent)] dark:border-white/10 dark:bg-zinc-800"
                >
